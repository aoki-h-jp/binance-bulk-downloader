...
downloader = BinanceBulkDownloader(data_type="bookTicker", timeperiod_per_file="monthly")
downloader.run_download()
...
downloader = BinanceBulkDownloader(data_type="bookTicker", asset="cm", timeperiod_per_file="monthly")
downloader.run_download()
